...
<html lang="en">
    <head>
        ...
        <meta property="og:image" content="<?php echo e(url('/assets/img/logo.png')); ?>" />
        ...
        <header class="flex items-center shadow bg-white border-b h-24 mb-8 py-4" role="banner">
            <div class="container flex items-center max-w-8xl mx-auto px-4 lg:px-8">
                <div class="flex items-center">
                    <a href="<?php echo e(url('/')); ?>" title="<?php echo e($page->siteName); ?> home" class="inline-flex items-center">
                        <img class="h-8 md:h-10 mr-3" src="<?php echo e(url('/assets/img/logo.svg')); ?>" alt="<?php echo e($page->siteName); ?> logo" />
...
<?php /**PATH /var/www/html/staging.mediamonitor.it/laravel/Modules/Cms/docs/source/_layouts/master.blade.php ENDPATH**/ ?>