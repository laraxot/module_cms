...
<section class="container max-w-6xl mx-auto px-6 py-10 md:py-12">
    <div class="flex flex-col-reverse mb-10 lg:flex-row lg:mb-24">
        <div class="mt-8">
            ...
            <h2 id="intro-powered-by-jigsaw" class="font-light mt-4">
                <?php echo e($page->siteDescription); ?></h2>

            <p class="text-lg">Give your documentation a boost with Jigsaw. <br class="hidden sm:block">Generate
                elegant, static docs quickly and easily.</p>
            ----------------
...
foreach ($__currentLoopData as $doc) {
    ...
    $loop = $__env->getLastLoop(); ?>
            <h2><a
                    href="<?php echo e(url($doc->getPath())); ?>"><?php echo e($doc->title); ?></a>
...
$loop = $__env->getLastLoop(); ?>
            ...
            <div class="flex my-10">
                <a href="<?php echo e(locale); ?>/docs/introduction"
                    title="<?php echo e($page->siteName); ?> getting started"
        ...
        <img src="/assets/img/logo-large.svg"
            alt="<?php echo e($page->siteName); ?> large logo"
