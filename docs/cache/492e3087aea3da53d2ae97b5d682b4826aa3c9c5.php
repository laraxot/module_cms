...
$loop = $__env->getLastLoop(); ?>
            ...
            <div class="flex my-10">
                <a href="<?php echo e(locale); ?>/docs/introduction" title="<?php echo e($page->siteName); ?> getting started" class="bg-blue-500 hover:bg-blue-600 font-normal text-white hover:text-white rounded mr-4 py-2 px-6">Get Started</a>
...
<?php echo $__env->make('_layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/staging.mediamonitor.it/laravel/Modules/Cms/docs/source/index.blade.php ENDPATH**/ ?>