...
class Builder extends Component
{
    ...
    public function chooseMenu(): void
    {
        if ($this->selectedMenu) {
            ...
            191    Parameter #2 $all_items of static method Modules\Cms\Http\Livewire\Menu\Builder::tree() expects Illuminate\Support\Collection&iterable<Modules\UI\Models\MenuItem>,
            Illuminate\Database\Eloquent\Collection given.
            */
